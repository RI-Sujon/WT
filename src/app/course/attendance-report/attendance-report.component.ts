...
export class AttendanceReportComponent implements OnInit {
  ...
  public attendanceMapWithBSSEROLL_listDaily: AttendanceMapWithBSSEROLL[] = [] ;
  public attendanceMapWithBSSEROLL_listMonthly: AttendanceMapWithBSSEROLL[] = [] ;
  public attendanceMapWithBSSEROLL_listAll: AttendanceMapWithBSSEROLL[] = [] ;
  ...
  ngOnInit(): void {
    ...
    this.choiceReportOption("Monthly") ;
    this.choiceReportOption("Daily") ; 
  }
  ...
  clearAttMap(){
    ...
    for(let i=0 ; i<this.attendanceMapWithBSSEROLL_listAll.length ; i++){
      this.attendanceMapWithBSSEROLL_listAll[i].attendanceCount = 0 ;
      this.attendanceMapWithBSSEROLL_listAll[i].percentage = "0" ;
      this.attendanceMapWithBSSEROLL_listAll[i].status = "" ;
      this.attendanceMapWithBSSEROLL_listMonthly[i].attendanceCount = 0 ;
      this.attendanceMapWithBSSEROLL_listMonthly[i].percentage = "0" ;
      this.attendanceMapWithBSSEROLL_listMonthly[i].status = "" ;
      this.attendanceMapWithBSSEROLL_listDaily[i].attendanceCount = 0 ;
      this.attendanceMapWithBSSEROLL_listDaily[i].percentage = "0" ;
      this.attendanceMapWithBSSEROLL_listDaily[i].status = "" ;
    }
  }

  choiceReportOption( value: string){
    if(value=="Daily"){
      console.log("==========<>><<><>");
  ...
  xyz(){
    ...
    for(var std of this.studentsOfCourse){
      ...
      this.attendanceMapWithBSSEROLL_listMonthly.push(temp) ;
      this.attendanceMapWithBSSEROLL_listDaily.push(temp) ;
      this.attendanceMapWithBSSEROLL_listAll.push(temp) ;
    }
  }
  ...
  dailyReport(ob: any, dateAndTime2: Date|any){
    ...
    for(var attMap of this.attendanceMapWithBSSEROLL_listDaily){
      var count = 0 ;
      for(var att of this.attendances){
        if(att.dateAndTime==dateAndTime){
  ...
  fullReport(){
    ...
    for(var attMap of this.attendanceMapWithBSSEROLL_listAll){
      var count = 0 ;
      for(var att of this.attendances){
        if(att.bsseroll==attMap.bsseRoll){
          count++ ;
  ...
  monthlyReport(ob: any, dateAndTime2: Date | any){
    ...
    for(var attMap of this.attendanceMapWithBSSEROLL_listMonthly){
      var count = 0 ;
      for(var att of this.attendances){
